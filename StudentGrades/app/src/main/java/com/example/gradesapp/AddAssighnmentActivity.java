...
public class AddAssighnmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_assighnment);
        ...
        createButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AssighnmentDAOReference.insert(
                    new Assighnment(
                        detailsField.getText().toString(),
                        assighnedDateField.getText().toString(),
                        dueDateField.getText().toString(),
                        Integer.parseInt(categoryIDField.getText().toString()),
                        Integer.parseInt(courseIDField.getText().toString()),
                        Float.parseFloat(earnedScoreField.getText().toString()),
                        Float.parseFloat(maxScoreField.getText().toString())
                    )
                );
